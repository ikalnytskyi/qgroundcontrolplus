...
public:
    ...
    QString brandImageIndoor() const { return QStringLiteral("/custom/img/QGCLogoFullIndoor.svg"); }
    QString brandImageOutdoor() const { return QStringLiteral("/custom/img/dronecode-black.svg"); }
...
private:
    ...
    void _installStartupOverlay(QQmlApplicationEngine *qmlEngine);
