...
DECLARE_SETTINGSFACT(VideoSettings, drivingGuideEnabled)
DECLARE_SETTINGSFACT(VideoSettings, drivingGuideCameraHeight)
DECLARE_SETTINGSFACT(VideoSettings, drivingGuideCameraTilt)
DECLARE_SETTINGSFACT(VideoSettings, drivingGuideCameraFov)
DECLARE_SETTINGSFACT(VideoSettings, drivingGuideCameraVfov)
DECLARE_SETTINGSFACT(VideoSettings, drivingGuideVehicleWidth)
DECLARE_SETTINGSFACT(VideoSettings, drivingGuideNearDistance)
DECLARE_SETTINGSFACT(VideoSettings, drivingGuideFarDistance)
DECLARE_SETTINGSFACT(VideoSettings, drivingGuideColor)
DECLARE_SETTINGSFACT(VideoSettings, drivingGuideLineWidth)
DECLARE_SETTINGSFACT(VideoSettings, drivingGuideCameraSideOffset)
DECLARE_SETTINGSFACT(VideoSettings, drivingGuideCameraFrontSetback)
