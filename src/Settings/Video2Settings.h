...
public:
    ...
    DEFINE_SETTINGFACT(drivingGuideEnabled)
    DEFINE_SETTINGFACT(drivingGuideCameraHeight)
    DEFINE_SETTINGFACT(drivingGuideCameraTilt)
    DEFINE_SETTINGFACT(drivingGuideCameraFov)
    DEFINE_SETTINGFACT(drivingGuideCameraVfov)
    DEFINE_SETTINGFACT(drivingGuideVehicleWidth)
    DEFINE_SETTINGFACT(drivingGuideNearDistance)
    DEFINE_SETTINGFACT(drivingGuideFarDistance)
    DEFINE_SETTINGFACT(drivingGuideColor)
    DEFINE_SETTINGFACT(drivingGuideLineWidth)
    DEFINE_SETTINGFACT(drivingGuideCameraSideOffset)
    DEFINE_SETTINGFACT(drivingGuideCameraFrontSetback)
